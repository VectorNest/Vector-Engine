...
| `POST /collection`      | `body: { id: number, pc: Address, name: string, fields: { name: string, type: "String" \| "Integer32" \| "Integer64" \| "Float" \| "Vector" \| "Boolean" \| "Image", properties?: { isPrimary?: boolean, default?: any, dimension?: number, autoIncrement?: boolean }}[] }` | `None`                                  | Creates a new collection in the resource.                                                                                                                                      |
| `DELETE /collection`    | `body: { id: number, pc: Address, name: string }`                                                                                                                                                                                                                | `None`                                  | Deletes a collection from the resource.                                                                                                                                        |
| `POST /searchInCollection` | `body: { id: number, pc: Address, collection: string, vectorField: string, query: any[] \| string, options?: { limit?: number, metricType?: "l2" \| "ip" \| "cosine" \| "jaccard" \| "hamming", searchFields?: string[] } }`                                      | `any[]`                                 | Searches for nearest neighbors within a specific collection. Automatically detects if the query is content or embeddings and includes images in the results if applicable.       |
| `POST /search`         | `body: { id: number, pc: Address, vectorField: string, query: any[] \| string, options?: { limit?: number, metricType?: "l2" \| "ip" \| "cosine" \| "jaccard" \| "hamming", searchFields?: string[] } }`                                                         | `{ [collection: string]: any[] }`       | Searches for nearest neighbors across all available collections. Automatically detects if the query is content or embeddings and includes images in the results if applicable.  |
