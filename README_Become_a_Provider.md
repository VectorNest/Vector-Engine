...
| `search(agreement: Agreement, resource: Resource, vectorField: string, query: any[] \| string, options?: { limit?: number; metricType?: MetricType; searchFields?: string[]; } ): Promise<{ [collection: string]: any[] }>` | Searches for nearest neighbors across all available collections. Automatically detects if the query is content or embeddings and includes images in the results if applicable.                                                                                                                                                      |
| `searchInCollection(agreement: Agreement, resource: Resource, collection: string, vectorField: string, query: any[] \| string, options?: { limit?: number; metricType?: MetricType; searchFields?: string[]; } ): Promise<any[]>` | Retrieves the nearest neighbors for the given query within a specific collection. Automatically detects if the query is content or embeddings and includes images in the results if applicable.                                                                                                                                     |
